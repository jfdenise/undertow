...
/**
 *
 * Interface that is provided by the container to retrieve annotations of a class.
 *
 *
 */
public interface AnnotationRetriever {
    Method[] getDeclaredMethods(Class<?> clazz) throws RuntimeException;
    boolean isAnnotationPresent(Class<?> clazz, Method m, Class<? extends Annotation> annotType) throws RuntimeException;
    Annotation[][] getParameterAnnotations(Class<?> clazz, Method m) throws RuntimeException;
    Annotation getAnnotation(Class<?> clazz, Class<? extends Annotation> annotType) throws RuntimeException;
